const footer = (contacts) => {
  ...
  footerNavCredits.innerHTML = `
    Copyright &copy; ${new Date().getFullYear()} <a href="https://www.linkedin.com/in/elliotgaramendi/" class="footer-nav__credits-author" target="_blank" rel="noreferrer">Cristopher Molina.</a> Todos los derechos reservados.
  `;
}
